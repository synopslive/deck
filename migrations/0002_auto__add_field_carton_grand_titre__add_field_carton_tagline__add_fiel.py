...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Carton.grand_titre'
        db.add_column('deck_carton', 'grand_titre', self.gf('django.db.models.fields.CharField')(default='', max_length='255', blank=True), keep_default=False)

        # Adding field 'Carton.tagline'
        db.add_column('deck_carton', 'tagline', self.gf('markupfield.fields.MarkupField')(default='', rendered_field=True, blank=True), keep_default=False)

        # Adding field 'Carton.tagline_markup_type'
        db.add_column('deck_carton', 'tagline_markup_type', self.gf('django.db.models.fields.CharField')(default='markdown', max_length=30, blank=True), keep_default=False)

        # Adding field 'Carton._tagline_rendered'
        db.add_column('deck_carton', '_tagline_rendered', self.gf('django.db.models.fields.TextField')(default='markdown'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Carton.grand_titre'
        db.delete_column('deck_carton', 'grand_titre')

        # Deleting field 'Carton.tagline'
        db.delete_column('deck_carton', 'tagline')

        # Deleting field 'Carton.tagline_markup_type'
        db.delete_column('deck_carton', 'tagline_markup_type')

        # Deleting field 'Carton._tagline_rendered'
        db.delete_column('deck_carton', '_tagline_rendered')
