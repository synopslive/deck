...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Carton.published_at'
        db.add_column('deck_carton', 'published_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Carton.published_at'
        db.delete_column('deck_carton', 'published_at')
