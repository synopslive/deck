...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Show.icon_image'
        db.add_column('deck_show', 'icon_image', self.gf('django.db.models.fields.files.ImageField')(default='http://synopslive.net/static/medias/cartons-ng/shows/unknown.png', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Show.icon_image'
        db.delete_column('deck_show', 'icon_image')
