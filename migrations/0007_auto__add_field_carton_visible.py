...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Carton.visible'
        db.add_column('deck_carton', 'visible', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Carton.visible'
        db.delete_column('deck_carton', 'visible')
