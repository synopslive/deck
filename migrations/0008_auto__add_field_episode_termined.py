...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('deck_episode', 'termined', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Episode.termined'
        db.delete_column('deck_episode', 'termined')
