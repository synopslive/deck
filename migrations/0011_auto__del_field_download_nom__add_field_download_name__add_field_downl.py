...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Download.nom'
        db.delete_column('deck_download', 'nom')

        # Adding field 'Download.name'
        db.add_column('deck_download', 'name', self.gf('django.db.models.fields.CharField')(default="L'\xc3\xa9mission", max_length=30), keep_default=False)

        # Adding field 'Download.extension'
        db.add_column('deck_download', 'extension', self.gf('django.db.models.fields.CharField')(default='.mp3', max_length=10, blank=True), keep_default=False)

        # Adding field 'Download.size'
        db.add_column('deck_download', 'size', self.gf('django.db.models.fields.CharField')(default='10 Mo', max_length=10, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Download.nom'
        db.add_column('deck_download', 'nom', self.gf('django.db.models.fields.CharField')(default='\xc3\x89mission', max_length=30), keep_default=False)

        # Deleting field 'Download.name'
        db.delete_column('deck_download', 'name')

        # Deleting field 'Download.extension'
        db.delete_column('deck_download', 'extension')

        # Deleting field 'Download.size'
        db.delete_column('deck_download', 'size')
