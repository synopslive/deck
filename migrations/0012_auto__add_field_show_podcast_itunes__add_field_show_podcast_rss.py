...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Show.podcast_itunes'
        db.add_column('deck_show', 'podcast_itunes', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)

        # Adding field 'Show.podcast_rss'
        db.add_column('deck_show', 'podcast_rss', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Show.podcast_itunes'
        db.delete_column('deck_show', 'podcast_itunes')

        # Deleting field 'Show.podcast_rss'
        db.delete_column('deck_show', 'podcast_rss')
