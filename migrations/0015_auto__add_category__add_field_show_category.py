...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('deck_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=30)),
            ('color', self.gf('django.db.models.fields.CharField')(default='#CCCCCC', max_length=20)),
            ('icon', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal('deck', ['Category'])

        # Adding field 'Show.category'
        db.add_column('deck_show', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['deck.Category'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table('deck_category')

        # Deleting field 'Show.category'
        db.delete_column('deck_show', 'category_id')
