...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('deck_episode', 'specific_livepage_url')

        # Deleting field 'Show.livepage_url'
        db.delete_column('deck_show', 'livepage_url')
