...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LivePage'
        db.create_table('deck_livepage', (
            ('show', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['deck.Show'], unique=True, primary_key=True)),
            ('synopsis', self.gf('django.db.models.fields.TextField')()),
            ('twitter_button_message', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('twitter_button_label', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('twitter_theme', self.gf('django.db.models.fields.TextField')()),
            ('producer_image', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('producer_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('producer_url', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('producer', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('footer', self.gf('markupfield.fields.MarkupField')(rendered_field=True, blank=True)),
            ('footer_markup_type', self.gf('django.db.models.fields.CharField')(default='markdown', max_length=30, blank=True)),
            ('css', self.gf('django.db.models.fields.TextField')()),
            ('_footer_rendered', self.gf('django.db.models.fields.TextField')()),
            ('image_top', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('link_top', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('deck', ['LivePage'])


    def backwards(self, orm):
        # Deleting model 'LivePage'
        db.delete_table('deck_livepage')
