...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LivePage.producer'
        db.delete_column('deck_livepage', 'producer')


    def backwards(self, orm):
        # Adding field 'LivePage.producer'
        db.add_column('deck_livepage', 'producer',
                      self.gf('django.db.models.fields.CharField')(default='SynopsLive', max_length=255),
                      keep_default=False)
    ...
    models = {
        ...
        'deck.livepage': {
            ...
            'producer_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
