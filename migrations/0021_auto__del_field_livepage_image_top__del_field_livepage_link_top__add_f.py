...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LivePage.image_top'
        db.delete_column('deck_livepage', 'image_top')

        # Deleting field 'LivePage.link_top'
        db.delete_column('deck_livepage', 'link_top')

        # Adding field 'LivePage.top_image'
        db.add_column('deck_livepage', 'top_image',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'LivePage.top_link_url'
        db.add_column('deck_livepage', 'top_link_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LivePage.image_top'
        db.add_column('deck_livepage', 'image_top',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'LivePage.link_top'
        db.add_column('deck_livepage', 'link_top',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'LivePage.top_image'
        db.delete_column('deck_livepage', 'top_image')

        # Deleting field 'LivePage.top_link_url'
        db.delete_column('deck_livepage', 'top_link_url')
    ...
    models = {
        ...
        'deck.livepage': {
            ...
            'twitter_subject': ('django.db.models.fields.CharField', [], {'default': "'R\\xc3\\xa9agissez en direct'", 'max_length': '255'}),
            'twitter_theme': ('django.db.models.fields.TextField', [], {'default': "'{}'"}),
            'twitter_title': ('django.db.models.fields.CharField', [], {'default': '"Vos r\\xc3\\xa9actions \\xc3\\xa0 l\'\\xc3\\xa9mission"', 'max_length': '255'})
        },
        'deck.show': {
