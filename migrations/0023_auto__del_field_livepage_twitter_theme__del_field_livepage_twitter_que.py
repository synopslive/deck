...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LivePage.twitter_theme'
        db.delete_column(u'deck_livepage', 'twitter_theme')

        # Deleting field 'LivePage.twitter_query'
        db.delete_column(u'deck_livepage', 'twitter_query')

        # Adding field 'LivePage.twitter_widget'
        db.add_column(u'deck_livepage', 'twitter_widget',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LivePage.twitter_theme'
        db.add_column(u'deck_livepage', 'twitter_theme',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)

        # Adding field 'LivePage.twitter_query'
        db.add_column(u'deck_livepage', 'twitter_query',
                      self.gf('django.db.models.fields.CharField')(default='SynopsLive OR @SynopsLive', max_length=255),
                      keep_default=False)

        # Deleting field 'LivePage.twitter_widget'
        db.delete_column(u'deck_livepage', 'twitter_widget')
