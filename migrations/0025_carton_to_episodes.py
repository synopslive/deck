...
class Migration(DataMigration):
    def forwards(self, orm):
        encountered_episodes = []
        for carton in orm.Carton.objects.all():
            episode = carton.episode

            if episode not in encountered_episodes:
                episode.carton_image = carton.bg_image
                episode.carton_title = carton.grand_titre
                episode.carton_content = carton.tagline
                episode.save()

                encountered_episodes.append(episode)
