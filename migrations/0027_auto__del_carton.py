...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'deck_carton')


    def backwards(self, orm):
        # Adding model 'Carton'
        db.create_table(u'deck_carton', (
            ('grand_titre', self.gf('django.db.models.fields.CharField')(max_length='255', blank=True)),
            ('tw_msg', self.gf('django.db.models.fields.CharField')(default='Tweeter avec', max_length=255, blank=True)),
            ...
            ('tw_url', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('fb_msg', self.gf('django.db.models.fields.CharField')(default=u"S'inscrire \xe0 l'\xe9v\xe9nement <strong>Facebook</strong>", max_length=255, blank=True)),
            ('fb_url', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('bg_image', self.gf('django.db.models.fields.files.ImageField')(default='http://synopslive.net/static/medias/cartons-ng/fonds/terrasse.jpg', max_length=100, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'deck', ['Carton'])
