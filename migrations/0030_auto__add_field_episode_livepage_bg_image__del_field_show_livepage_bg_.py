...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Episode.livepage_bg_image'
        db.add_column(u'deck_episode', 'livepage_bg_image',
        ...
        # Adding field 'Show.livepage_bg_image'
        db.add_column(u'deck_show', 'livepage_bg_image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Episode.livepage_bg_image'
        db.delete_column(u'deck_episode', 'livepage_bg_image')
        ...
        # Deleting field 'Show.livepage_bg_image'
        db.delete_column(u'deck_show', 'livepage_bg_image')
