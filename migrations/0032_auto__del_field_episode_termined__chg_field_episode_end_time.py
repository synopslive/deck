...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Episode.termined'
        db.delete_column(u'deck_episode', 'termined')


        # Changing field 'Episode.end_time'
        db.alter_column(u'deck_episode', 'end_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 6, 0, 0)))

    def backwards(self, orm):
        # Adding field 'Episode.termined'
        db.add_column(u'deck_episode', 'termined',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Episode.end_time'
        db.alter_column(u'deck_episode', 'end_time', self.gf('django.db.models.fields.DateTimeField')(null=True))
