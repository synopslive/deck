...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Show.external_url'
        db.add_column(u'deck_show', 'external_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Show.external_url_title'
        db.add_column(u'deck_show', 'external_url_title',
                      self.gf('django.db.models.fields.CharField')(default="Visiter le site d\xc3\xa9di\xc3\xa9 \xc3\xa0 l'\xc3\xa9mission", max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Show.external_url'
        db.delete_column(u'deck_show', 'external_url')

        # Deleting field 'Show.external_url_title'
        db.delete_column(u'deck_show', 'external_url_title')
