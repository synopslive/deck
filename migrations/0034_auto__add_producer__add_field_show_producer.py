...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'deck_producer', (
        ...
        db.send_create_signal(u'deck', ['Producer'])

        # Adding field 'Show.producer'
        db.add_column(u'deck_show', 'producer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['deck.Producer'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Producer'
        db.delete_table(u'deck_producer')

        # Deleting field 'Show.producer'
        db.delete_column(u'deck_show', 'producer_id')
