...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Producer.regroup_shows'
        db.add_column(u'deck_producer', 'regroup_shows',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Producer.regroup_shows'
        db.delete_column(u'deck_producer', 'regroup_shows')
